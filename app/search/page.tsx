...
import { Search, Briefcase, Folder, FileText, ArrowRight, CornerDownRight } from 'lucide-react';
...
export default async function SearchPage({ searchParams }: SearchPageProps) {
  ...
  return (
    <>
      <Navbar />
      <main className="flex-1 bg-mesh-gradient blueprint-grid text-white pt-32 pb-24 relative">
        {/* Glow decoration */}
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="max-w-2xl space-y-4 mb-10 text-left">
            ...
            <p className="text-text-secondary text-sm md:text-base leading-relaxed">
              Search products, blog articles, and categories across WarishLabs.
            </p>
          </div>
