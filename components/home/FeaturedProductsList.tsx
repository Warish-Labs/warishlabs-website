              ...
              <CardHeader className="space-y-3 pt-8 pb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge className="text-[10px] font-bold bg-white/10 border-white/5 text-zinc-300">
                  ...
                  {product.logoUrl ? (
                    ...
                    <div className="w-10 h-10 rounded border border-white/10 bg-accent-subtle flex items-center justify-center font-bold text-accent shrink-0">
                      {firstLetter}
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {product.technologies.map((t) => (
                      <span
                        key={t.technology.id}
                        className="px-2 py-1 bg-black/40 border border-white/5 rounded text-[10px] font-semibold text-zinc-400 uppercase tracking-wider"
                      >
                        {t.technology.name}
                      </span>
                    ))}
