  ...
  return (
    <>
      ...
      <div className="mt-12 text-center select-none">
        <Link
          href="/categories"
          className="inline-flex items-center gap-1.5 px-6 py-3 bg-zinc-950 border border-border text-white hover:border-accent rounded-xl text-xs font-bold uppercase tracking-wider transition-all"
        >
          View all categories →
        </Link>
      </div>
